# Free Game Font License Source Pack v0.2
...
- `game_font_sources_verified_v0.2.csv`: 47 verified font/source rows.
- `game_font_license_source_pack_v0.2.xlsx`: filterable workbook.
- `font_license_questions_v0.2.csv`: 10 practical questions to ask before shipping a font in a game.
...
- display/title: 16
- multilingual/fallback: 2
- pixel/retro: 6
- readable UI/body: 17
- terminal/monospace: 6
