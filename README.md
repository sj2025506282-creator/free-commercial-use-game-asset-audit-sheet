# Free Commercial-Use Game Asset Sources Audit Sheet v0.1

This is a starter audit sheet for indie game developers who need free game assets with clear commercial-use signals.
...
- `commercial_use_game_asset_sources_audit_v0.1.csv`: the audit sheet.
